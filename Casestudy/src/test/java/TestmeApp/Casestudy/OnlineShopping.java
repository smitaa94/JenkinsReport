...
public class OnlineShopping{
...

	{
		...
		//for failure
		//driver.findElement(By.xpath("//*[@id=\"horizontalTab\"]/div[2]/div/div")).click();
	...
	public void testRegistration() throws Exception
	{
		...
		driver.findElement(By.name("userName")).sendKeys("siiim123");
		...
		Assert.assertEquals(Expected,Actual);
		driver.findElement(By.name("firstName")).sendKeys("simuma");
		driver.findElement(By.name("lastName")).sendKeys("naraing");
		...
		driver.findElement(By.name("emailAddress")).sendKeys("suirann@gmail.com");
	...
	public void getResultAfterMethod(ITestResult result)throws IOException
	{
		if(result.getStatus()==ITestResult.FAILURE)
		{
			...
			FileUtils.copyFile(src,new File("C:\\Users\\training_h2a.06.15\\Desktop\\Selenium workspace\\s2.jpg"));


			/*
			 * TakesScreenshot sht=(TakesScreenshot)driver; File
			 * src=sht.getScreenshotAs(OutputType.FILE); String
			 * path=System.getProperty("user.dir"+"/extent-reports/snapshots/"+result.
			 * getName()+".png"); System.out.println(path)
			 */;

			 logger.addScreenCaptureFromPath("C:\\Users\\training_h2a.06.15\\Desktop\\Selenium workspace",result.getName());
			 logger.log(Status.FAIL, MarkupHelper.createLabel(result.getName()+"- Test case Failed",ExtentColor.RED));
	...
	public void startReportBeforeTest()
	{
		...
		//existing data will remain, new tests will be appended to the existing report. If the the supplied path does not exist, a new file will be created.
	...
	{
		logger=extent.createTest("Closing of Report");
		extent.flush();
